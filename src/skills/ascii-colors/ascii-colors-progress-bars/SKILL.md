...
Output:
```
Processing: 100%|████████████████████| 100/100 [00:01<00:00, 98.50it/s]
```
...
def download_file(url: str, local_path: str):
    ...
    ASCIIColors.green(f"✓ Downloaded to {local_path}")
...
| `progress_char` | `str` | `"█"` | Character for filled portion |
