...
| **LoLLMs** | Natural language → SQL translation, result explanation |
    ...
    def _extract_schema(self) -> str:
        ...
        for (table_name,) in tables:
            ...
            for fk in fks:
                ...
                schema_parts.append(f"  - FOREIGN KEY: {from_col} → {table}({to_col})")
    ...
    if "tool_calls" in metadata:
        for call in metadata["tool_calls"]:
            if call["name"] == "execute_sql":
                print(f"\n📊 Executed SQL: {call['params']['query']}")
...
- Explain your reasoning"""
    ...
    def run_interactive(self):
        """Run interactive CLI."""
        print("🗄️  Natural Language Database")
